...
const { getMaterialUsageData, getTotalRequested, approveUpload, confirmEdit, updateStatusNotifications, getRemainingDetails} = require('../controllers1/supClerkController'); 
...
router.post("/confirm-edit", authenticateToken, confirmEdit);
