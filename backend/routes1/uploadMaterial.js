...
const { insertMaterialsFromDB2 , getMaterials , deleteMaterial, updateMaterial } = require('../controllers1/uploadMaterialController');
...
router.get('/fetch-materials-db2', insertMaterialsFromDB2);
